// ===== UI/DOM =====
    const els = {
      ...
      accessInviteOwnerHint: document.getElementById("accessInviteOwnerHint"),
      accessInviteLabelInput: document.getElementById("accessInviteLabelInput"),
      accessInviteCodeInput: document.getElementById("accessInviteCodeInput"),
      accessInviteCreateBtn: document.getElementById("accessInviteCreateBtn"),
      accessInviteRefreshBtn: document.getElementById("accessInviteRefreshBtn"),
      accessInviteList: document.getElementById("accessInviteList"),
